...
glmnet.fit<-train(LifeExpectancy ~ . - LifeExpectancy - log_LifeExpectancy - Country.factor - Year.factor - Country,
               data=training,
               method="glmnet",
               trControl=fitControl,
               na.action=na.exclude
...
glmnet.country.fit<-train(LifeExpectancy ~ . - LifeExpectancy - log_LifeExpectancy - Country.factor - Year.factor,
               data=training,
               method="glmnet",
               trControl=fitControl,
               na.action=na.exclude
