...
life_expectancy <- mutate(life_expectancy, log(GDP))

# Potential spread issue
pairs(life_expectancy[,c("LifeExpectancy","log(GDP)")])

# Log transformation
life_expectancy <- mutate(life_expectancy, log(LifeExpectancy))
...
pairs(life_expectancy[,c("LifeExpectancy", "GDP", "log(LifeExpectancy)","log(GDP)")])

# HIV_AIDS
life_expectancy <- mutate(life_expectancy, log(HIV_AIDS))
pairs(life_expectancy[,c("LifeExpectancy", "HIV_AIDS", "log(LifeExpectancy)","log(HIV_AIDS)")])


# Diphtheria
life_expectancy <- mutate(life_expectancy, log(Diphtheria))
pairs(life_expectancy[,c("LifeExpectancy", "Diphtheria", "log(LifeExpectancy)","log(Diphtheria)")])
# Missing data creates an interesting scatterplot range/spread


# Polio
life_expectancy <- mutate(life_expectancy, log(Polio))
pairs(life_expectancy[,c("LifeExpectancy", "Polio", "log(LifeExpectancy)","log(Polio)")])
...
glmnet.fit<-train(LifeExpectancy~Status+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+HIV_AIDS+GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
               data=training,
               method="glmnet",
...
stepwise.fit<-train(LifeExpectancy~Status+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+HIV_AIDS+GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
                  data=training,
...
#
set.seed(1234)
tree.fit<-train(LifeExpectancy~Status+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+HIV_AIDS+GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
                    data=training,
...
set.seed(1234)
knn.fit<-train(LifeExpectancy~Status+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+HIV_AIDS+GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
                data=training,
