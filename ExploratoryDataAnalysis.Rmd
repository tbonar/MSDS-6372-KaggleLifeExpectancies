...
life_expectancy$log_LifeExpectancy <- life_expectancy$`log(LifeExpectancy)`
life_expectancy$log_HIV_AIDS <- life_expectancy$`log(HIV_AIDS)`
life_expectancy$log_GDP <- life_expectancy$`log(GDP)`
...
glmnet.fit<-train(log_LifeExpectancy~Developed+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+log_HIV_AIDS+log_GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
               data=training,
               method="glmnet",
...
stepwise.fit<-train(log_LifeExpectancy~Developed+Year+AdultMortality+InfantDeaths+Alcohol+HepatitisB+Measles+BMI+Polio+TotalExpenditure+Diphtheria+log_HIV_AIDS+log_GDP+Population+Thinness_1_19_years+IncCompOfResources+Schooling,
                  data=training,
