...
glmnet.fit<-train(LifeExpectancy~AdultMortality+InfantDeaths+Alcohol+Polio+Diphtheria,
               data=training,
               method="glmnet",
...
set.seed(1234)
stepwise.fit<-train(LifeExpectancy~AdultMortality+InfantDeaths+Alcohol+Polio+Diphtheria,
                  data=training,
...
#
set.seed(1234)
tree.fit<-train(LifeExpectancy~AdultMortality+InfantDeaths+Alcohol+Polio+Diphtheria,
                    data=training,
...
set.seed(1234)
knn.fit<-train(LifeExpectancy~AdultMortality+InfantDeaths+Alcohol+Polio+Diphtheria,
                data=training,
