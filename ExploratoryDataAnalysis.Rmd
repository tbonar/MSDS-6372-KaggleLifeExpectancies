...
# Fitting the models (re-using code from RLab4.R that was provided in unit 6)
...
# TODO: I added "na.action=na.exclude" but not sure if we should keep it (need to figure out what is excluded exactly)
...
# Creating Tree Model while choosing complexity parameter via 10 fold CV
```{r}
set.seed(1234)
