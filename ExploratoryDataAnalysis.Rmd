...
# 10 countries with only 1 year of data were removed and the data frame went from 2938 to 2928 rows
```
...
nrow(life_expectancy)
# 3 years were removed and with 183 countries left, the dataframe went from 2928 to 2379 rows
```
...
TODO: set South Sudan to 0 and check what's left
...
Consider dropping this one, too many inaccuracies
...
Probably drop it; missing data and covered by HDI
